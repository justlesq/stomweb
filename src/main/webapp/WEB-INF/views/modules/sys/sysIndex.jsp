	...
	<div id="main">
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
				...
				<div id="right">
					<iframe id="mainFrame" name="mainFrame" src="" style="overflow:visible;" frameborder="no" width="100%" height="800"></iframe>
				</div>
			</div>
		   <%-- <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://stom.com" target="_blank">stom</a> ${fns:getConfig('version')}
			</div>--%>
		</div>
	</div>
	<script type="text/javascript"> 
